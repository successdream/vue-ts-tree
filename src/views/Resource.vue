<template>
  <div id="Resource" style="position:absolute;top:60px;width:100%;">
    <div class="Tree" v-if = 'dealTree' >
     <div class="title">
        <span>标题1</span>
        <span>标题2</span>
        <span>标题3</span>
...
export default class Resource extends Vue {
  ...
  mounted() {
    ...
    // lists.addEventListener("dragover",function(event) 
